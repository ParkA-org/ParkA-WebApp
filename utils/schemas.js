...
export const CreateAccountSchema = Yup.object().shape({
  name: Yup.string()
    .min(5, "Debe introducir más caracteres")
    .required("Requerido"),
  lastName: Yup.string()
    .min(5, "Debe introducir más caracteres")
    .required("Requerido"),
...
export const ForgotPasswordSchema = Yup.object().shape({
  ...
  password: Yup.string()
    .min(8, "Debe tener una longitud de 8 caracteres la contraseña")
    .required("Requerido"),
});
...
export const CreateParkingSchema = Yup.object().shape({
  countParking: Yup.number("Introduzca un número")
    .positive("Costo debe ser mayor que 0")
    .required("Requerido"),
  latitude: Yup.string().required("Requerido"),
  longitude: Yup.string().required("Requerido"),
  parkingName: Yup.string().required("Requerido"),
  priceHours: Yup.number("Introduzca un número")
    .positive("Costo debe ser mayor que 0")
    .required("Requerido"),
...
export const CreateVehicleSchema = Yup.object().shape({
  licensePlate: Yup.string()
    .max(7, "Máximo 7 caracterés como placa")
    .required("Requerido"),
...
export const CreateReviewSchema = Yup.object().shape({
  title: Yup.string()
    .max(50, "Máximo 50 caracterés como título de la reseña")
    .required("Requerido"),
  review: Yup.string()
    .max(150, "Máximo 50 caracterés como título de la reseña")
    .required("Requerido"),
  calification: Yup.number("Introduzca un número")
    .positive("La calificacion debe ser mayor que 0")
    .required("Requerido"),
});
