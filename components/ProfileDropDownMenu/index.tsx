  ...
  return (
    <DropdownMenu>
      ...
      <DropdownContent>
        ...
        >
          <img src="/images/mdi_chat.svg" />
          <h4>Chats</h4>
        </DropdownItem>
        <DropdownItem
          style={{ cursor: "pointer" }}
          onClick={() => router.push("/profile/paymentMethods")}
        >
          <img src="/images/mdi_payment.svg" />
        ...
        >
          <img src="/images/mdi_settings.svg" />
